...
void Joueur::save() {
    ...
    ostringstream im;
    im << numSave;
    ofstream f(("sdmc:/3ds/ZeldaOLB/olb" + im.str() + ".dat").c_str(),ios::out | ios::binary);
...
void Joueur::load() {
    ...
    ostringstream im;
    im << numSave;
    ifstream f(("sdmc:/3ds/ZeldaOLB/olb" + im.str() + ".dat").c_str(),ios::in | ios::binary);
    if(!f.is_open()) return;
...
void Joueur::setBouclier(int b) {
    ...
    if (oni) {
        ...
        else boucl = new Bouclier(IMG_Load("romfs:/images/link/bouclierOni.png"), 10);
    }
    else boucl = new Bouclier(IMG_Load(("romfs:/images/link/bouclier" + im.str() + ".png").c_str()), bouclier);
}
...
void Joueur::setTunique(int t) {
    ...
    else image = IMG_Load(("romfs:/images/link/link" + im.str() + ".png").c_str());
...
void Joueur::setEpee(int e) {
    ...
    im << epee;
    if (oni) {
        if (hasObjet(O_MASQUE)==2) imageEpee = IMG_Load("romfs:/images/link/epeeOni2.png");
        else imageEpee = IMG_Load("romfs:/images/link/epeeOni.png");
    }
    else imageEpee = IMG_Load(("romfs:/images/link/epee" + im.str() + ".png").c_str());
