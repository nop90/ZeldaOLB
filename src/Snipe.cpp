...
rebond(false), element(FEU) {
    ...
    switch (id) {
        ...
        case 9 : // boule de feu bleue
            ...
            image = IMG_Load("romfs:/images/objet/projectiles10.png");
            break;
        ...
        case 11 : // boule de glace grosse
            ...
            image = IMG_Load("romfs:/images/objet/projectiles11.png");
            break;
        case 12 : // boule de feu verte
            w=7; h=7; force=0; renvoyable=true; element=MORTEL;
            image = IMG_Load("romfs:/images/objet/projectiles12.png");
            break;
    }
